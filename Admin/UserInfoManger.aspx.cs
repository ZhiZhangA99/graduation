...
public partial class Admin_UserInfoManger : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            DropDownList1.DataTextField = "BuMenName";
            DropDownList1.DataValueField = "BuMenId";
            DropDownList1.DataBind();

            DropDownList1.Items.Add("所有部门");
    ...
    protected void btnDel_Click(object sender, EventArgs e)
    {
        ...
        Alert.AlertAndRedirect("删除成功", "UserInfoManger.aspx");
    }
    ...
    public DataSet GetCodeBy(int iCount)
    {
        ...
        string bumen =DropDownList1.SelectedItem.Text;
        string UserTruename =TextBox1.Text.Trim();
    ;
