...
<tr bgcolor=#ffffff><td>
                <table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 232px; height: 23px">
                            <asp:TextBox ID="TextBox2" runat="server" MaxLength="200"  onclick="fPopCalendar(event,this,this)" onfocus="this.select()" 
                                Width="163px" ReadOnly="True"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="width: 90px; height: 23px">
                            通知内容：</td>
                    ...
                    <tr>
                        <td align="center" colspan="3" style="height: 34px; width: 868px;">
                            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="修改通知" /></td>
                    </tr>
                </table>
</td></tr>
