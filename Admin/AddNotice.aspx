<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNotice.aspx.cs" Inherits="UserManger_AddNotice" %>
...
<tr align="center" bgcolor=#cccccc><td><b>
    添加通知</td></tr>
                ...
                <table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td align="left" style="width: 232px; height: 24px">
                            <asp:TextBox ID="TextBox1" runat="server" Width="631px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                ControlToValidate="TextBox1" ErrorMessage="通知名称必须输入"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" style="width: 232px; height: 23px">
                            <asp:TextBox ID="TextBox2" runat="server" MaxLength="200"  onclick="fPopCalendar(event,this,this)" onfocus="this.select()" 
                                Width="163px"></asp:TextBox>&nbsp;&nbsp;
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                ControlToValidate="TextBox2" ErrorMessage="请输入时间"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 131px; height: 104px">
                            通知内容：</td>
                        <td align="left" style="width: 232px; height: 104px">
                            <asp:TextBox ID="TextBox5" runat="server" Height="266px" MaxLength="200" TextMode="MultiLine"
                                Width="608px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td  colspan="3" style="height: 34px; width: 868px;">
                            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="添加通知" /></td>
                    </tr>
                </table>
</td></tr>
