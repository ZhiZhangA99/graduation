    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td style="width: 90px; height: 24px">
                            账号：*</td>
                        <td align="left" style="width: 421px; height: 24px">
                            <asp:TextBox ID="txtName" runat="server" MaxLength="200" Width="163px" ReadOnly="True"></asp:TextBox>
                ...
                <asp:TextBox ID="pic" runat="server" CssClass="inputBox" ReadOnly="True" Width="72px"></asp:TextBox><input
                    ...
                    <tr>
                        <td style="width: 90px; height: 23px">
                            姓名：</td>
                        <td align="left" style="width: 421px; height: 23px">
        ...
        <tr>
            <td style="width: 90px; height: 23px">
                性别：</td>
            <td align="left" style="width: 421px; height: 23px">
                <asp:TextBox ID="TextBox11" runat="server" MaxLength="200" ReadOnly="True" Width="65px"></asp:TextBox></td>
        </tr>
                    <tr>
                        <td style="width: 90px; height: 23px">
                            出生日期：</td>
                        <td align="left" style="width: 421px; height: 23px">
                            <asp:TextBox ID="TextBox3" runat="server" MaxLength="200" Width="163px"  onclick="fPopCalendar(event,this,this)" onfocus="this.select()"  ReadOnly="True"></asp:TextBox>
                    ...
                    <tr>
                        <td style="width: 90px; height: 23px">
                            学历：</td>
                        <td align="left" style="width: 421px; height: 23px">
                            <asp:TextBox ID="TextBox10" runat="server" MaxLength="200" ReadOnly="True" Width="163px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="width: 90px; height: 23px">
                            电子邮件：</td>
                    ...
                    <tr>
                        <td style="width: 90px; height: 23px">
                            入职时间：</td>
                        <td align="left" style="width: 421px; height: 23px">
                            <asp:TextBox ID="TextBox7" runat="server" MaxLength="200" Width="163px"  onclick="fPopCalendar(event,this,this)" onfocus="this.select()"  ReadOnly="True"></asp:TextBox></td>
                    </tr>
        <tr>
            <td style="width: 90px; height: 23px">
                联系地址：</td>
                ...
                <asp:TextBox ID="TextBox4" runat="server" MaxLength="200" Width="542px"></asp:TextBox></td>
                    ...
                    <tr>
                        <td style="width: 90px; height: 23px">
                            所在部门：</td>
                        <td align="left" style="width: 421px; height: 23px">
                            <asp:TextBox ID="TextBox1" runat="server" MaxLength="200" ReadOnly="True" Width="163px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="width: 90px; height: 23px">
                            职位：</td>
                        <td align="left" style="width: 421px; height: 23px">
                            <asp:TextBox ID="TextBox8" runat="server" MaxLength="200" ReadOnly="True" Width="163px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="width: 90px; height: 23px">
                            角色：</td>
                        <td align="left" style="width: 421px; height: 23px">
                            <asp:TextBox ID="TextBox9" runat="server" MaxLength="200" ReadOnly="True" Width="163px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td align="center" colspan="3" style="height: 34px">
                            <hr />
                            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="确认修改" /></td>
                    </tr>
                    <tr>
